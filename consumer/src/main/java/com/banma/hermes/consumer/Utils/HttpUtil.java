...
import com.banma.hermes.consumer.serviceImpl.ConsumerServiceImpl;
...
public class HttpUtil {
     ...
     * @return 文件
     */
    public static File downloadFile(String fileName,String urlAddress, String downloadDir) {
        ...
        try {
            ...
            while ((size = bufferedInputStream.read(buf)) != -1) {
                ...
                // 打印当前文件下载的百分比
                if (len * 100 / fileLength == 100){
                    logger.info("filedownload success");
                }
            }
            // 关闭输出流
            outputStream.close();
